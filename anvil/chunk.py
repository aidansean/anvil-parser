...
class Chunk:
    ...
    def get_block(
        ...
        if self.version is None or self.version < _VERSION_17w47a:
            ...
            # https://minecraft.gamepedia.com/index.php?title=Chunk_format&oldid=1153403#Block_format
    ...
    def stream_chunk(
        self, _index: int = 0, _section: Union[int, nbt.TAG_Compound] = None
    ) -> Generator[Block, None, None]:
        """
    ...
    def from_region(cls, region: Union[str, Region], chunk_x: int, chunk_z: int):
        ...
        chunk_x
            The x coordinate of the chunk in the region
        chunk_z
            The z coordinate of the chunk in the region
